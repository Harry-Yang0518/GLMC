...
python main_bn.py --dataset cifar10 -a mresnet32 --etf_cls --imbalance_rate 0.01 --imbalance_type step --lr 0.01 --seed 2021 --epochs 200 --loss ce --bn_type cbn \
--store_name cls_batchn_IR_${IB}_${LOSS}_etf "
