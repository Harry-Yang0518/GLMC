...
class ResNet_modify(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=100, nf=64, etf_cls=False, fnorm='none', center=False, l2norm=False):
    ...
    def forward(self, x, ret=None):
        ...
        # Center and normalize the features
        if self.center:
            feature_mean = feature.mean(dim=0, keepdim=True)
...
def resnet32(num_class=10, etf_cls=False, fnorm='none', center=False, l2norm=False):
